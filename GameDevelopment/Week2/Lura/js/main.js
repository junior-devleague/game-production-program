...
var mainState = {
	...
	preload: function(){
		...
		game.load.image('player', 'assets/Creeper2.png');
		game.load.image('ground', 'assets/GroundHorizontal.png');
		game.load.image('obstacle', 'assets/GroundVertical.png');
		game.load.image('obstacle2', 'assets/NewPlatform.png');
	...
	create: function(){
		...
		game.stage.backgroundColor = '#00FFFB';
		...
		//this.obstacle = game.add.sprite(700,game.world.height, 'obstacle2');
		//this.obstacle.scale.setTo(1,0.2);
		//this.obstacle.anchor.setTo(0,1);
		//game.physics.arcade.enable(this.obstacle);
		//this.obstacle.body.immovable = true;
		...
		scoreText = game.add.text(16, 16, 'score: 0', { fontSize: '32px', fill: '#8700FF' });
	},
