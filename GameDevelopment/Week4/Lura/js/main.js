...
var mainState = {
	...
	preload: function(){
		...
		game.load.image('background', 'assets/original.png');
		game.load.image('ground', 'assets/wallHorizontal.png');
		game.load.image('obstacle', 'assets/wallVertical.png');
		game.load.spritesheet('ship', 'assets/Rocket.png', 32, 32);
		game.load.spritesheet('dragon', 'assets/Boss.png', 32, 32);
		game.load.spritesheet('cat', 'assets/Nyan.png', 32, 32);
	...
	create: function(){
		...
		this.player = game.add.sprite(game.width/8, game.world.height*(7/8), 'ship');
	...
	update: function(){
		...
		if (score >= 150){
			...
			levelText = game.add.text(350,100, 'Level 4', {fill: '#00FFFF'});
			this.player.loadTexture('dragon',15,true);
		} else if (score >= 100){
			console.log("level up");
